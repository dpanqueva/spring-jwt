package com.pi.booking.hotel.room.controller.jwt;


import com.pi.booking.hotel.room.config.jwt.JwtProviderConfig;
import com.pi.booking.hotel.room.model.dto.JwtDTO;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> token(@RequestBody UserDTO user) {
        ...
        Authentication authentication = authenticationManager.authenticate
                (new UsernamePasswordAuthenticationToken(user.getCorreo(), user.getPassword()));
        /**
